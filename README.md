...
This repository contains a library of my notes on the first half of the content on the "Machine Learning with Python" certification course by freeCodeCamp, which I created as part of self-studying Python and am sharing here for use as a reference resource. The first half of the content for this course covers TensorFlow with Python. This is an extensive library of my notes on this section of the course, covering the fundamental aspects of TensorFlow with Python. This covers essential topics on machine learning, neural networks, natural language processing, and reinforcement learning using this (the TensorFlow) framework. This consists of 32 PDF files below, each corresponding to a specific video lecture in this section of the course. 
